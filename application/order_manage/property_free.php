...
$user_home_car_free = $order_manage_class->user_home_property_free($current_property_id, $current_hose_id);
ob_clean();
if ($user_home_car_free){
    echo json_encode($user_home_car_free,JSON_UNESCAPED_UNICODE);
    return;
}
echo 0;
return;